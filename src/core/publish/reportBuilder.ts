...
export function buildPublishReport(input: BuildReportInput): {
  ...
  if (!hasReportHeader && !hasAnyFindings) {
    ...
    const fallbackMarkdown = `## 🩺 Repo Doctor Report
...
_This report was automatically generated by Repo Doctor._`;
  ...
  lines.push("---");
  lines.push("");
  lines.push("_This report was automatically generated by Repo Doctor._");
